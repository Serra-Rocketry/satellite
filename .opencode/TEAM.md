# Equipe de Desenvolvimento - Satellite Project

Este documento define a estrutura da equipe de desenvolvimento e code review para o projeto Satellite (Team #100), incluindo skills especializadas, agentes, e workflows.
...
- `firmware/REFACTORING_PLAN.md` - Plano completo v1.0
