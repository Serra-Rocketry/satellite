# OpenCode Skills - Helike PocketQube

Esta pasta contém as skills especializadas e workflows para desenvolvimento da missao Helike PocketQube (Team #100 - Serra Rocketry).
...
3. Criar testes (Test Engineer)
4. Documentar (Documentation Specialist)
...
**Expertise**: Arquitetura embarcada, organizacao de tasks, otimizacao de performance
...
### 🧪 Test Engineer
**Expertise**: Unit tests, testes de hardware, simulacao Python, analise de dados
...
### 📚 Documentation Specialist
**Expertise**: Doxygen, ADRs, diagramas Mermaid, documentacao tecnica
...
## Projeto Helike - Contexto

### Tecnologias
- **Hardware**: ESP32-C3 Super Mini
- **Linguagem**: C/C++ (Arduino/ESP-IDF)
- **RTOS**: Nao utilizado (single-core)
- **Comunicação**: LoRa, GPS, Telemetria
- **Testing**: Unity (unit tests), Python (simulation)

### Arquitetura
- Firmware single-core, sem pinning de tasks
- Coleta de sensores, telemetria LoRa e logging local (SD + fallback LittleFS)
- Modulos de calculo em `lib/calc/` para validacao de dados e deteccao de apogeu
...
**Projeto**: Helike PocketQube v1.0  
